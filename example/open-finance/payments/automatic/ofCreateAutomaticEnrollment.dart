...
void main() async {
  ...
  dynamic response = await ofCreateAutomaticEnrollment(efi);
  print(response);
}

dynamic ofCreateAutomaticEnrollment(EfiPay efi) async {
  dynamic body = {
    'pagador': {
      'cpf': '01234567890',
      'cnpj': '01234567890123',
  ...
  return await efi.call('ofCreateAutomaticEnrollment', body: body);
}