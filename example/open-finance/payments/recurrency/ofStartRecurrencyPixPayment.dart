...
void main() async {
  ...
  dynamic response = await ofStartRecurrencyPixPayment(efi);
  print(response);
}

dynamic ofStartRecurrencyPixPayment(EfiPay efi) async {
  dynamic body = {
    'pagador': {
  ...
  return await efi.call('ofStartRecurrencyPixPayment', body: body);
}