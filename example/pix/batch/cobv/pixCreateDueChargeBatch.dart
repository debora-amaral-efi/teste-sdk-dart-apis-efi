...
void main() async {
  ...
  dynamic response = await pixCreateDueChargeBatch(efi, '');
  print(response);
}

dynamic pixCreateDueChargeBatch(EfiPay efi, String loteId) async {
  ...
  return await efi.call('pixCreateDueChargeBatch', params: params, body: body);
}
